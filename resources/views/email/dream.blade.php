...
<html lang="it-IT" style="width:100%;">
  <head>
      ...
      <title>Astro - Melahel - Interpretazione dei sogni</title>
                    ...
                    <tr>
                        <td style="padding:24px 20px 24px 20px;text-align:center;">
                            ...
                            <p style="margin:0 0 8px 0;font-size:16px;line-height:1.4;font-weight:400;color:#333333;text-align:center;">
                                Hai appena richiesto di interpretare il sogno che riporto qui sotto:
                            </p>
                            ...
                            <h3 style="margin:0 0 10px 0;font-size:20px;font-weight:700;color:#081524;">
                              {{ $data['title'] ?? '' }}
                            </h3>
                          
                            <p style="margin:0;font-size:16px;line-height:1.5;color:#333333;text-align:left;">
                              {{ $data['description'] ?? '' }}
                            </p>
