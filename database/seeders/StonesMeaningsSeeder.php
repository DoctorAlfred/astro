        ...
        $stones = [
                ...
                [
                    ...
                    'translations' => [
                        [
                            'language'     => 'it',
                            'name'         => 'Tormalina Nera',
                            'origin'       => 'Brasile, Africa, Afghanistan',
                            'type'         => 'Ciclosilicato',
                            'color'        => 'Nero',
                            'chakra'       => 'Radice',
                            'zodiac_signs' => 'Capricorno, Scorpione',
                            'description'  => 'Nel simbolismo esoterico è associata al radicamento, alla stabilità e alla protezione.',
                            'usage'        => 'Indicata come simbolo di centratura, confini personali e disciplina interiore.',
                            'powers'       => ['radicamento', 'stabilità', 'protezione'],
                        ],
                        [
                            'language'     => 'en',
                            'name'         => 'Black Tourmaline',
                            'origin'       => 'Brazil, Africa, Afghanistan',
                            'type'         => 'Cyclosilicate',
                            'color'        => 'Black',
                            'chakra'       => 'Root',
                            'zodiac_signs' => 'Capricorn, Scorpio',
                            'description'  => 'In esoteric symbolism, it is associated with grounding, stability and protection.',
                            'usage'        => 'Used as a symbol of centering, personal boundaries and inner discipline.',
                            'powers'       => ['grounding', 'stability', 'protection'],
                        ],
                    ],
                ],
            ],
            ...
            [
                ...
                'translations' => [
                    [
                        'language'     => 'it',
                        'name'         => 'Tormalina Anguria',
                        'origin'       => 'Brasile, Afghanistan, Madagascar',
                        'type'        => 'Ciclosilicato',
                        'color'        => 'Verde e rosa/rosso',
                        'chakra'       => 'Cuore',
                        'zodiac_signs' => 'Bilancia, Toro',
                        'description'  => 'Varietà bicolore associata simbolicamente all’integrazione, all’armonia e alla costruzione di relazioni equilibrate.',
                        'usage'        => 'Indicata per meditazioni sul cuore, collaborazione e trasformazione delle relazioni.',
                        'powers'       => ['integrazione', 'armonia', 'amore consapevole'],
                    ],
                    [
                        'language'     => 'en',
                        'name'         => 'Watermelon Tourmaline',
                        'origin'       => 'Brazil, Afghanistan, Madagascar',
                        'type'        => 'Cyclosilicate',
                        'color'        => 'Green and pink/red',
                        'chakra'       => 'Heart',
                        'zodiac_signs' => 'Libra, Taurus',
                        'description'  => 'A bicoloured variety symbolically associated with integration, harmony and balanced relationships.',
                        'usage'        => 'Used for heart meditation, cooperation and relationship transformation.',
                        'powers'       => ['integration', 'harmony', 'conscious love'],
                    ],
                ],
            ],
            [
